      ...
      <ProfileCard>
        ...
        <Box sx={{ mb: 4 }}>
          <Typography variant="body1" sx={{ color: '#636E72', mb: 3, lineHeight: 1.8, fontSize: '1.1rem' }}>
            👋 Ganesh Lonare | 💻 Passionate about Software Development | 🌱 Always learning & coding | ✨ Let's code something incredible together! 🚀
          </Typography>
        </Box>
        ...
        <Box sx={{ mb: 4 }}>
          <StatsBox>
            ...
            <Typography sx={{ fontSize: '1.1rem' }}>https://ganeshlonare.vercel.app/</Typography>
          </StatsBox>
          <StatsBox>
            <GitHub sx={{ color: '#462872', fontSize: 24 }} />
            <Typography sx={{ fontSize: '1.1rem' }}>ganeshlonare</Typography>
          </StatsBox>
          <StatsBox>
            <Code sx={{ color: '#462872', fontSize: 24 }} />
            <Typography sx={{ fontSize: '1.1rem' }}>ganeshlonare311</Typography>
          </StatsBox>
          <StatsBox>
