...
const initialModuleData: ModuleData[] = [
  {
    id: 1,
    title: "Module 01",
    subtitle: "Java Fundamentals Module",
    completed: false,
    lessons: [
      { id: '1-1', title: "Java Variables And Data Types", completed: false },
      { id: '1-2', title: "Taking Input", completed: false },
      { id: '1-3', title: "Java Operators", completed: false },
      { id: '1-4', title: "Conditionals", completed: false },
    ],
  },
  {
    id: 2,
    ...
    completed: false,
    lessons: [
      { id: '2-1', title: "Java Variables And Data Types", completed: false },
      { id: '2-2', title: "Taking Input", completed: false },
      { id: '2-3', title: "Java Operators", completed: false },
      { id: '2-4', title: "Conditionals", completed: false },
    ],
  },
];
        ...
        <div className="flex-1 overflow-y-auto h-[calc(100vh-80px)]">
          ...
          <div className="h-16 flex items-center justify-between px-16 bg-gray-50 sticky">
            <span className="text-lg text-gray-800 font-medium">
              Lecture : Building RESTful APIs with Express.js
            </span>
            <FormControlLabel
              control={
                <Checkbox
